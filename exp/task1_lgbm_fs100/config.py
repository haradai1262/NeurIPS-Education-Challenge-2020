...
if TARGET_TASK == '1':
    LGB_MDOEL_PARAMS['metric'] = ['auc', 'binary_logloss']
    LGB_MDOEL_PARAMS['objective'] = 'binary'
if TARGET_TASK == '2':
    LGB_MDOEL_PARAMS['metric'] = ['multi_logloss', 'multi_error']
    LGB_MDOEL_PARAMS['objective'] = 'multiclass'
    LGB_MDOEL_PARAMS['num_class'] = 4
