...
def train_1fold(preds, preds_test, trn_idx, val_idx, X_train, y_train, x_test, cat_features_index):
    ...
    if TARGET_TASK == '1':
        ...
        preds[val_idx] = model.predict_proba(x_val)
